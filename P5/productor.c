...
int main(int argc, char **argv)
{
    ...
    almacen1 = mq_open("/ALMACEN1", O_CREAT | O_WRONLY, 0777, &attr); // Creamos la cola de mensajes almacen1, nuestro acceso a ella será en modo sólo escritura
    almacen2 = mq_open("/ALMACEN2", O_CREAT | O_RDONLY, 0777, &attr); // Creamos la cola de mensajes almacen2, nuestro acceso a ella será en modo sólo lectura
